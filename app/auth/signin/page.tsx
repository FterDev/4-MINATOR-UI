    ...
    return (
        <form onSubmit={handleSignIn}>
            <Auth text="Please login to start playing.">
                <FmInput id="email" name="email" title="E-Mail" value={email} onBlur={(e) => emailValidation.validateEmail(e)} onChange={(e) => setEmail(e)} isErrored={emailError.isErrored} errorText={emailError.errorText} placeholder="fluffy@unicorn.com" type="email" textAlign="center" />
                <FmInput id="password" name="password" title="Password" value={password} onBlur={(e) => passwordValidation.validateOnlyEmpty(e)} onChange={(e) => setPassword(e)} isErrored={passwordError.isErrored} errorText={passwordError.errorText} placeholder="●●●●●●●" type="password" textAlign="center" />
